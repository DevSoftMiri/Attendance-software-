...
const definitions = [
    ...
    },
    {
        ...
        fields: {
            ...
            appliedLeaveRequestId: { type: DataTypes.INTEGER },
            appliedLeaveMode: { type: DataTypes.STRING },
            expectedCheckInTime: { type: DataTypes.DATE },
            expectedCheckOutTime: { type: DataTypes.DATE },
